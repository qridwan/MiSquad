...
const SignIn: FC = () => {
  ...
  return (
    <>
      <div className="flex items-center gap-2 w-full max-w-[1100px] mx-[20%] my-10">
        <img className="h-8 w-8" src="/squadLogo.svg" alt="" />
        <span className="text-2xl">MySquad</span>
      </div>
      <div className="mx-[5vw] my-5 flex min-h-[80vh] items-center justify-center lg:my-10">
        <div className="w-full max-w-[1100px]">
          ...
          <div className="flex flex-col-reverse items-center justify-center gap-10 md:mt-5 md:flex-row md:gap-5 lg:mt-10">
            <div className="flex-1">
              <img className="h-auto w-full" src="/loginill.svg" alt="" />
            </div>
            ...
            <div className="mt-12 flex flex-1 flex-col items-center gap-4 md:items-start lg:mt-24">
              <h1 className="text-center text-3xl md:text-left md:text-4xl">
                Hi Buddy! Welcome to MySquad platform
              </h1>
              <p className="text-center text-xl md:text-left md:text-2xl">
                Make it easy and fun to stay close to your favourite people.
              </p>
